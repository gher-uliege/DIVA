...
!C Eliminate contours that are too small or fall outside the box
 ...
 444    continue       
        ...
        call makecont(x,y,ip,npmax,nc,topo,nx,ny,xmin,xmax,ymin,ymax,ic,surf,xcorn)
        write(6,*) 'Finished'
...
!C23456
      subroutine makecont(x,y,ip,npmax,nc,topo,nx,ny,xmin,xmax,ymin,ymax,ic,surf,xcorn)
...
100      continue
      ...
      wangle=wangle+RIII*dacos((dx*dxt+dy*dyt)/(dsqrt((dx*dx+dy*dy)*(dxt*dxt+dyt*dyt))))
