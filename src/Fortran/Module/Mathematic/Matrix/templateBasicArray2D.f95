...
! Procedure 2 : print information on the array
! ---------------------------------------------
...
! Procedure 3 : destruction of the array
! ---------------------------------------
...
! Procedure 5 : get the size X of the array
! -------------------------------------------
...
! Procedure 10 : insert value in array (scracth the previous one)
! ---------------------------------------------------------------
...
! Procedure 11 : add value in array (value = old value + new value)
! -----------------------------------------------------------------
...
! Procedure 12 : get the value in the array
! ------------------------------------------
...
! Procedure 5b : allocated memory to the array
! ---------------------------------------------
...
! Procedure 7 : getting the array size
! --------------------------------------
...
! Procedure 8 : transfer data from workingArray to secondworkingArray
! ----------------------------------------------------------------------
...
! Procedure 9 : transfer data from secondworkingArray to workingArray
! -----------------------------------------------------------------------
...
! Procedure 11 : get the value in the array
! ------------------------------------------
...
! Procedure 16 : set the starting point of the array
! ---------------------------------------------------
...
! Procedure 17 : get the starting point of the array
! ---------------------------------------------------
...
! Procedure 18 : get the final position in the array with respect to given dimension
! -----------------------------------------------------------------------------------
