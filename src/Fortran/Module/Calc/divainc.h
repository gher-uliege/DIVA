...
!C            (-1 ==> no element is created; +i = element i is created)
      ...
      COMMON /PTRL/ LKLINK,LKSORT,LKSKYH,LKCONN,LKLOCE,LKELOS,LKINDT,LKDATA,LKLOCS,LKCNDI,LKTPOL
!C
...
!C
      COMMON /PTRS/ LTCOOG,LTDATA,LTUPPE,LTLOWE,LTDIAG,LTRHSG,LTKELE,LTRHSE,LTVELE,LTSHAG,LTGRDS,LTCNDI,LTPROP,LTCELE, &
...
!C              0 = no
!C              1 = yes
      COMMON/GENE/ ITYP,ISYM,IPB,NNEL,NDDLE,NDATA,NDATL,NG,ISPEC,NCOND,INFO,NNPR,ITCS,ISTF, IREG, ICOORDCHANGE,RCOORDCHANGE &
                   ,isspheric
!C
...
!C
      COMMON /TOPO/ DELTAX,DELTAY,NNT,NNT1,NNINT,NDDLT,NELT,NTERM,NEX,NEY,IMATRX
...
!C
      COMMON /PRB2/ALPHA0,ALPHA1,WC1,VISC,RL0,VARBAK,OBSER,UMEAN,THETA,INBU
      COMMON /MUJMB/HMMU
!C
...
!C  - DYKM  : KM/DEGRE in LATITUDE
      ...
      COMMON /GRID/ XORI,YORI,DX,DY,VALEX,NX,NY,RLATMIN,RLATMAX,RLATMEAN,RLONMIN,RLONMAX,RLONMEAN, &
...
!C	- TBESS : TABULATION OF THE BESSEL FUNCTION
      ...
      COMMON /CROC/ TMAX,TMAY,TMIX,TMIY,NCAT,NCAX,NCAY,NCAZ,TLEX,TLEY,TLCX,TLCY,NELKNTC,LKNTC,OPTI,NONLOC,LKELOS1,TBESS,RPI
