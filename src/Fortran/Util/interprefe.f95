...
!C Read data (just coordinates, not value)
 ...
 5           continue
             ...
             NDATA=NDATA+1
               ...
               call bilininl(C,x0f,dxxf,dyxf,y0f,dxyf,dyyf,imaxf,jmaxf,RRR,XX,YY)
 ...
 99      continue
        ...
        write(*,*) imaxc,jmaxc,kmaxc,iprec,nbmots,valexc
         return
               ...
               subroutine bilininl(UF,x0f,dxxf,dyxf,y0f,dxyf,dyyf,imaxf,jmaxf,UT,xt,yt)
!c                 ========
...
!C Interpolate...
                  UT= rj* ( ri * UF(ii+1,jj+1) + ( 1 - ri )*UF(ii,jj+1) ) &
                   + (1 -rj) * ( ri * UF(ii+1,jj) + ( 1 - ri )*UF(ii,jj) )
