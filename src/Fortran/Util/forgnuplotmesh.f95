...
!  ====
   ...
   CALL createFile(outputFile,'fort.69',formType=STD_FORMATTED)
...
!    ----------------------------
   DO i1 = 1, nbOfCell
      ...
      WRITE(outputFileUnit,*) xValue1, yValue1, 0, i1
      WRITE(outputFileUnit,*) xValue2, yValue2, 0, i1
      WRITE(outputFileUnit,*) 
      WRITE(outputFileUnit,*) xValue3, yValue3, 0, i1
      WRITE(outputFileUnit,*) xValue3, yValue3, 0, i1
      WRITE(outputFileUnit,*) 
      WRITE(outputFileUnit,*) 
