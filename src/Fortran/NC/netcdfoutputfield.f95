!C--------------------------
!C     PROGRAM NCOUTPUTFIELDF
!C--------------------------
!C     December 2006: C. Troupin
!C     Update: M.Ouberdous, October 2007
!
!C     provides an output in NetCDF format for the analyzed field
!
!C     input =
!C     -----
!
...
!C     ------
!
!C     analyzed_field.nc: analysis output file in NetCDF format
!
!C ----------------------------------------------------------------------
...
!C    The type of the variable; in this case = float
      ...
      retval = nf_def_var(ncid, "analyzed_field",NF_FLOAT, NDIMS, dimids, varid)
      if (retval .ne. nf_noerr) call handle_err(retval)
...
!Cý    Writes the data into the netCDF file
