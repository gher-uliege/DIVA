...
{\bf NOTE:} You can specify several ODV spreadsheet files as input files, one name per line, in {\tt datasource}, {\bf provided they have the same naming, depth and qualtify conventions}.
