...
C  INPUT/OUTPUT FILES : OPEN statement
      ...
      open(unit=20,file='fort.20',form='unformatted',access='stream')
#else
...
#ifdef DIVABINARYFILES
      open(unit=71,file='fort.71',form='unformatted',access='stream')
#else
      open(unit=71,file='fort.71')
#endif
#ifdef DIVABINARYFILES
      open(unit=72,file='fort.72',form='unformatted',access='stream')
#else
      open(unit=72,file='fort.72')
#endif
#ifdef DIVABINARYFILES
      open(unit=73,file='fort.73',form='unformatted',access='stream')
#else
      open(unit=73,file='fort.73')
#endif
#ifdef DIVABINARYFILES
      open(unit=79,file='fort.79',form='unformatted',access='stream')
#else
...
#ifdef DIVABINARYFILES
      open(unit=82,file='fort.82',form='unformatted',access='stream')
#else
      open(unit=82,file='fort.82')
#endif
#ifdef DIVABINARYFILES
      open(unit=83,file='fort.83',form='unformatted',access='stream')
#else
...
#ifdef DIVABINARYFILES
      open(unit=86,file='fort.86',form='unformatted',access='stream')
#else
      ...
      write(6,920)
 920  format(72('&'),/,20x,'D.I.V.A. - 4.6.10 - Execution track ...',
     &       /,72('&'),/)
C
...
C                    to be printed)
 ...
 830  format(/,10x,31('$'),/,10x,'CALL TO TOPOLO MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 835  format(/,10x,31('$'),/,10x,'CALL TO MESHGN MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 840  format(/,10x,31('$'),/,10x,'CALL TO DATAPR MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 850  format(/,10x,31('$'),/,10x,'CALL TO BCONDI MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 860  format(/,10x,31('$'),/,10x,'CALL TO CONSTR MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 880  format(/,10x,31('$'),/,10x,'CALL TO SOLVER MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 890  format(/,10x,31('$'),/,10x,'CALL TO STORES MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 900  format(/,10x,31('$'),/,10x,'CALL TO ESTERR MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 902  format(/,10x,31('$'),/,10x,'CALL TO COVAR  MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 905  format(/,10x,31('$'),/,10x,'CALL TO COORD  MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
 906  format(/,10x,31('$'),/,10x,'CALL TO GCVFAC MODULE: IPR = '
     &       ,I2,/,10x,31('$'),/)
...
C#endif
 ...
 999  write(6,*)' MAXIMUM NUMBER OF INTEGER USED: ',IENMAX
      ...
      write(6,910)
 910  format(/,72('&'),/,20x,'D.I.V.A. - 4.6.10 - Execution Completed !'
     &       ,/,72('&'))
