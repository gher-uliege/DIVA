...
C ----------------------------------------------------
      ...
      PARAMETER(NMAX=4000000,MMAX=4000000,NCMAX=10000,NRMAX=1000)
#else
...
C      stop
      ...
      XJC=
     & ((XJ3-XJ2)*(XJ3+XJ2)+(YJ3+YJ2)*(YJ3-YJ2))*(YJ2-YJ1)/2
     & -((XJ2-XJ1)*(XJ2+XJ1)+(YJ2+YJ1)*(YJ2-YJ1))*(YJ3-YJ2)/2
      
      XJC=-XJC/VJ
     
      YJC=-(XJ2-XJ1)*XJC 
     &+((XJ2-XJ1)*(XJ2+XJ1)+(YJ2+YJ1)*(YJ2-YJ1))/2
      YJC=YJC/(YJ2-YJ1) 
      A1=XJC
      A2=YJC     
